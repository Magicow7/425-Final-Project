...
namespace Utils
{
    ...
    public class RaycastNonAllocWrapper
    {
        ...
        {
            int hitCount = Physics.RaycastNonAlloc(origin, direction, _hits, distance, _layerMask, _triggerInteraction);
            hit = _hits[0];
            return hitCount > 0;
        }
        ...
        {
            int hitCount = Physics.OverlapSphereNonAlloc(origin, radius, _colliders, _layerMask, _triggerInteraction);
        ...
        {
            int hitCount = Physics.SphereCastNonAlloc(origin, radius, direction, _hits, distance, _layerMask, _triggerInteraction);
            hit = _hits[0];
            return hitCount > 0;
        }
        ...
        {
            int hitCount = Physics.OverlapCapsuleNonAlloc(point0, point1, radius, _colliders, _layerMask, _triggerInteraction);
            colliders = _colliders;
            return hitCount > 0;
        }
    }
